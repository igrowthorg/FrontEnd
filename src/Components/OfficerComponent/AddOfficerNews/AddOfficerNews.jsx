...
const AddNews = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            const res = await instance.post('/officer/add-news', formData, header);
            console.log(res.data);

            if (res.status === 200) {
                alert('News Added Successfully');
                document.getElementById("officer-news-send").reset();
            }
        }
        catch (err) {
    ...
    return (
        <div className='addNew-container'>
            <div id='add-news'>
                <h3>Add News</h3>
                <form onSubmit={submit} id='officer-news-send'>
                    <div className="row">
