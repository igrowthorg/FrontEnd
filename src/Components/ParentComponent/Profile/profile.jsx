...
export default function Profile() {
    ...
    if (authenticated && profile) return (
        <div className='profile-container'>
            <div className='profile-top'><span>Parent Profile</span></div>
            <div className='profile-bottom'>
                <div className='buttom-left'>
                    <div className='left-header'>
                        <div className='inputField-cover'><label>Guardian NIC : </label><input type="text" placeholder='Guardian NIC' disabled={true} value={profile.guardian_nic} /></div>
                        <div className='inputField-cover'><label>Email : </label><input type="text" placeholder='Email' disabled={true} value={profile.email} /></div>
                    ...
                    <div className='left-body'>
                        <form onSubmit={submit} id='officerUpdate'>
                            <div className='inputField-cover'><label>Mother Name :</label><input onChange={handleMotherName} value={motherName} type='text' id='mother-name' name='mother--name' required={true} /></div>

                            <div className='inputField-cover'><label>Father Name :</label><input onChange={handleFatherName} value={fatherName} type='text' id='father-name' name='father--name' required={true} /></div>

                            <div className='inputField-cover'><label>Guardian Name :</label><input onChange={handleGuardianName} value={guardianName} type='text' id='father-name' name='guardian-name' required={true} /></div>
                            ...
                            <div className='inputField-cover'><label>Address :</label><input onChange={handleAddress} value={address} type='text' id='address' name='address' required={true} /></div>
